            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Founded in 2010, Business Name began with a simple mission:
                    to provide exceptional products and services that make a
                    difference in our customers' lives.
                  </p>
                  <p>
                    What started as a small operation has grown into a thriving
                    business, serving hundreds of satisfied customers across the
                    region. Our journey has been marked by continuous
                    innovation, unwavering commitment to quality, and a deep
                    understanding of our customers' needs.
                  </p>
                  <p>
                    Today, we continue to build on our strong foundation,
                    expanding our offerings while staying true to the core
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our unique approach and commitment to excellence make us the
                  preferred choice for our customers.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="flex flex-col items-center space-y-2 border rounded-lg p-6 bg-background">
                ...
                <p className="text-center text-muted-foreground">
                  ...
                  tailoring our solutions to meet their specific needs.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border rounded-lg p-6 bg-background">
                <h3 className="text-xl font-bold">Experienced Team</h3>
                <p className="text-center text-muted-foreground">
                  Our team brings decades of combined experience and expertise
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
              <TeamMember
                ...
                imageSrc="/placeholder.png?height=300&width=300"
              />
              <TeamMember
                name="Jane Smith"
